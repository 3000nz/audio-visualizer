  ...
  <div id="panel">
    ...
    <div class="panel-section sliders">
      <div class="slider-row">
        ...
        <input type="range" id="sl-sensitivity" min="1" max="100" step="1" value="100" />
        <span class="sl-val" id="val-sensitivity">100</span>
      </div>
      <div class="boost-row">
        <button class="boost-btn active" data-boost="1">1×</button>
        <button class="boost-btn" data-boost="2">2×</button>
        <button class="boost-btn" data-boost="3">3×</button>
      ...
      <div class="slider-row cosmos-only">
        ...
        <input type="range" id="sl-ringsize" min="-100" max="100" step="1" value="46" />
        <span class="sl-val" id="val-ringsize">+46</span>
      </div>
      <div class="slider-row cosmos-only">
        <label>Brightness</label>
        <input type="range" id="sl-ringbrightness" min="0.2" max="3" step="0.05" value="3.0" />
        <span class="sl-val" id="val-ringbrightness">3.0×</span>
      </div>
      <div class="slider-row">
        <label>Bloom</label>
        <input type="range" id="sl-bloom" min="0" max="3" step="0.05" value="3.0" />
        <span class="sl-val" id="val-bloom">3.0</span>
      </div>
      <div class="slider-row">
        <label>Speed</label>
        <input type="range" id="sl-speed" min="0.1" max="3" step="0.05" value="2.5" />
        <span class="sl-val" id="val-speed">2.5×</span>
      </div>
      <div class="slider-row">
        <label>Intensity</label>
        <input type="range" id="sl-intensity" min="0.2" max="3" step="0.05" value="3.0" />
        <span class="sl-val" id="val-intensity">3.0×</span>
      </div>
    </div>
