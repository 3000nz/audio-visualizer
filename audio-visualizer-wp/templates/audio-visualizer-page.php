  ...
  <div id="panel">
    ...
    <div class="panel-section sliders">
      <div class="slider-row">
        ...
        <input type="range" id="sl-sensitivity" min="0.5" max="5" step="0.05" value="1.5" />
        <span class="sl-val" id="val-sensitivity">1.5×</span>
      </div>
      <div class="boost-row">
        <button class="boost-btn" data-sens="2">2×</button>
        <button class="boost-btn" data-sens="3">3×</button>
        <button class="boost-btn" data-sens="4">4×</button>
        <button class="boost-btn" data-sens="5">5×</button>
      </div>
      <div class="slider-row">
        <label>Bloom</label>
