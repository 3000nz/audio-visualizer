...
`].filter(jn).join(`
`)),a=Pr(a),a=ws(a,t),a=Rs(a,t),o=Pr(o),o=ws(o,t),o=Rs(o,t),a=Cs(a),o=Cs(o),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
}`;function Mu(i,e,t){let n=new ea;const r=new Ae,s=new Ae,a=new lt,o=new _u({depthPacking:3201}),c=new gu,h={},l=t.maxTextureSize,u={0:1,1:0,2:2},m=new ut({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ae},radius:{value:4}},vertexShader:vu,fragmentShader:xu}),d=m.clone();d.defines.HORIZONTAL_PASS=1;const _=new wt;_.setAttribute("position",new Et(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new pt(_,m),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let f=this.type;this.render=function(w,b,U){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const S=i.getRenderTarget(),x=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),G=i.state;G.setBlending(0),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const O=f!==3&&this.type===3,k=f===3&&this.type!==3;for(let q=0,H=w.length;q<H;q++){const K=w[q],V=K.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",K,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const oe=V.getFrameExtents();if(r.multiply(oe),s.copy(V.mapSize),(r.x>l||r.y>l)&&(r.x>l&&(s.x=Math.floor(l/oe.x),r.x=s.x*oe.x,V.mapSize.x=s.x),r.y>l&&(s.y=Math.floor(l/oe.y),r.y=s.y*oe.y,V.mapSize.y=s.y)),V.map===null||O===!0||k===!0){const pe=this.type!==3?{minFilter:1003,magFilter:1003}:{};V.map!==null&&V.map.dispose(),V.map=new Lt(r.x,r.y,pe),V.map.texture.name=K.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const fe=V.getViewportCount();for(let pe=0;pe<fe;pe++){const Fe=V.getViewport(pe);a.set(s.x*Fe.x,s.y*Fe.y,s.x*Fe.z,s.y*Fe.w),G.viewport(a),V.updateMatrices(K,pe),n=V.getFrustum(),T(b,U,V.camera,K,this.type)}V.isPointLightShadow!==!0&&this.type===3&&E(V,U),V.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(S,x,C)};function E(w,b){const U=e.update(v);m.defines.VSM_SAMPLES!==w.blurSamples&&(m.defines.VSM_SAMPLES=w.blurSamples,d.defines.VSM_SAMPLES=w.blurSamples,m.needsUpdate=!0,d.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Lt(r.x,r.y)),m.uniforms.shadow_pass.value=w.map.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(b,null,U,m,v,null),d.uniforms.shadow_pass.value=w.mapPass.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(b,null,U,d,v,null)}function y(w,b,U,S){let x=null;const C=U.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)x=C;else if(x=U.isPointLight===!0?c:o,i.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const G=x.uuid,O=b.uuid;let k=h[G];k===void 0&&(k={},h[G]=k);let q=k[O];q===void 0&&(q=x.clone(),k[O]=q,b.addEventListener("dispose",N)),x=q}if(x.visible=b.visible,x.wireframe=b.wireframe,S===3?x.side=b.shadowSide!==null?b.shadowSide:b.side:x.side=b.shadowSide!==null?b.shadowSide:u[b.side],x.alphaMap=b.alphaMap,x.alphaTest=b.alphaTest,x.map=b.map,x.clipShadows=b.clipShadows,x.clippingPlanes=b.clippingPlanes,x.clipIntersection=b.clipIntersection,x.displacementMap=b.displacementMap,x.displacementScale=b.displacementScale,x.displacementBias=b.displacementBias,x.wireframeLinewidth=b.wireframeLinewidth,x.linewidth=b.linewidth,U.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const G=i.properties.get(x);G.light=U}return x}function T(w,b,U,S,x){if(w.visible===!1)return;if(w.layers.test(b.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&x===3)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,w.matrixWorld);const O=e.update(w),k=w.material;if(Array.isArray(k)){const q=O.groups;for(let H=0,K=q.length;H<K;H++){const V=q[H],oe=k[V.materialIndex];if(oe&&oe.visible){const fe=y(w,oe,S,x);w.onBeforeShadow(i,w,b,U,O,fe,V),i.renderBufferDirect(U,null,O,fe,w,V),w.onAfterShadow(i,w,b,U,O,fe,V)}}}else if(k.visible){const q=y(w,k,S,x);w.onBeforeShadow(i,w,b,U,O,q,null),i.renderBufferDirect(U,null,O,q,w,null),w.onAfterShadow(i,w,b,U,O,q,null)}}const G=w.children;for(let O=0,k=G.length;O<k;O++)T(G[O],b,U,S,x)}function N(w){w.target.removeEventListener("dispose",N);for(const U in h){const S=h[U],x=w.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}function Su(i){function e(){let R=!1;const le=new lt;let X=null;const Y=new lt(0,0,0,0);return{setMask:function(te){X!==te&&!R&&(i.colorMask(te,te,te,te),X=te)},setLocked:function(te){R=te},setClear:function(te,Te,Ve,et,st){st===!0&&(te*=et,Te*=et,Ve*=et),le.set(te,Te,Ve,et),Y.equals(le)===!1&&(i.clearColor(te,Te,Ve,et),Y.copy(le))},reset:function(){R=!1,X=null,Y.set(-1,0,0,0)}}}function t(){let R=!1,le=null,X=null,Y=null;return{setTest:function(te){te?he(i.DEPTH_TEST):ie(i.DEPTH_TEST)},setMask:function(te){le!==te&&!R&&(i.depthMask(te),le=te)},setFunc:function(te){if(X!==te){switch(te){case 0:i.depthFunc(i.NEVER);break;case 1:i.depthFunc(i.ALWAYS);break;case 2:i.depthFunc(i.LESS);break;case 3:i.depthFunc(i.LEQUAL);break;case 4:i.depthFunc(i.EQUAL);break;case 5:i.depthFunc(i.GEQUAL);break;case 6:i.depthFunc(i.GREATER);break;case 7:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}X=te}},setLocked:function(te){R=te},setClear:function(te){Y!==te&&(i.clearDepth(te),Y=te)},reset:function(){R=!1,le=null,X=null,Y=null}}}function n(){let R=!1,le=null,X=null,Y=null,te=null,Te=null,Ve=null,et=null,st=null;return{setTest:function(Ye){R||(Ye?he(i.STENCIL_TEST):ie(i.STENCIL_TEST))},setMask:function(Ye){le!==Ye&&!R&&(i.stencilMask(Ye),le=Ye)},setFunc:function(Ye,Dt,Ut){(X!==Ye||Y!==Dt||te!==Ut)&&(i.stencilFunc(Ye,Dt,Ut),X=Ye,Y=Dt,te=Ut)},setOp:function(Ye,Dt,Ut){(Te!==Ye||Ve!==Dt||et!==Ut)&&(i.stencilOp(Ye,Dt,Ut),Te=Ye,Ve=Dt,et=Ut)},setLocked:function(Ye){R=Ye},setClear:function(Ye){st!==Ye&&(i.clearStencil(Ye),st=Ye)},reset:function(){R=!1,le=null,X=null,Y=null,te=null,Te=null,Ve=null,et=null,st=null}}}const r=new e,s=new t,a=new n,o=new WeakMap,c=new WeakMap;let h={},l={},u=new WeakMap,m=[],d=null,_=!1,v=null,p=null,f=null,E=null,y=null,T=null,N=null,w=new Ue(0,0,0),b=0,U=!1,S=null,x=null,C=null,G=null,O=null;const k=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,H=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(K)[1]),q=H>=1):K.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),q=H>=2);let V=null,oe={};const fe=i.getParameter(i.SCISSOR_BOX),pe=i.getParameter(i.VIEWPORT),Fe=new lt().fromArray(fe),ke=new lt().fromArray(pe);function W(R,le,X,Y){const te=new Uint8Array(4),Te=i.createTexture();i.bindTexture(R,Te),i.texParameteri(R,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(R,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ve=0;Ve<X;Ve++)R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY?i.texImage3D(le,0,i.RGBA,1,1,Y,0,i.RGBA,i.UNSIGNED_BYTE,te):i.texImage2D(le+Ve,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,te);return Te}const J={};J[i.TEXTURE_2D]=W(i.TEXTURE_2D,i.TEXTURE_2D,1),J[i.TEXTURE_CUBE_MAP]=W(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[i.TEXTURE_2D_ARRAY]=W(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),J[i.TEXTURE_3D]=W(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),he(i.DEPTH_TEST),s.setFunc(3),ue(!1),Be(1),he(i.CULL_FACE),_e(0);function he(R){h[R]!==!0&&(i.enable(R),h[R]=!0)}function ie(R){h[R]!==!1&&(i.disable(R),h[R]=!1)}function Pe(R,le){return l[R]!==le?(i.bindFramebuffer(R,le),l[R]=le,R===i.DRAW_FRAMEBUFFER&&(l[i.FRAMEBUFFER]=le),R===i.FRAMEBUFFER&&(l[i.DRAW_FRAMEBUFFER]=le),!0):!1}function be(R,le){let X=m,Y=!1;if(R){X=u.get(le),X===void 0&&(X=[],u.set(le,X));const te=R.textures;if(X.length!==te.length||X[0]!==i.COLOR_ATTACHMENT0){for(let Te=0,Ve=te.length;Te<Ve;Te++)X[Te]=i.COLOR_ATTACHMENT0+Te;X.length=te.length,Y=!0}}else X[0]!==i.BACK&&(X[0]=i.BACK,Y=!0);Y&&i.drawBuffers(X)}function ze(R){return d!==R?(i.useProgram(R),d=R,!0):!1}const P={100:i.FUNC_ADD,101:i.FUNC_SUBTRACT,102:i.FUNC_REVERSE_SUBTRACT};P[103]=i.MIN,P[104]=i.MAX;const Ne={200:i.ZERO,201:i.ONE,202:i.SRC_COLOR,204:i.SRC_ALPHA,210:i.SRC_ALPHA_SATURATE,208:i.DST_COLOR,206:i.DST_ALPHA,203:i.ONE_MINUS_SRC_COLOR,205:i.ONE_MINUS_SRC_ALPHA,209:i.ONE_MINUS_DST_COLOR,207:i.ONE_MINUS_DST_ALPHA,211:i.CONSTANT_COLOR,212:i.ONE_MINUS_CONSTANT_COLOR,213:i.CONSTANT_ALPHA,214:i.ONE_MINUS_CONSTANT_ALPHA};function _e(R,le,X,Y,te,Te,Ve,et,st,Ye){if(R===0){_===!0&&(ie(i.BLEND),_=!1);return}if(_===!1&&(he(i.BLEND),_=!0),R!==5){if(R!==v||Ye!==U){if((p!==100||y!==100)&&(i.blendEquation(i.FUNC_ADD),p=100,y=100),Ye)switch(R){case 1:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.ONE,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case 1:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}f=null,E=null,T=null,N=null,w.set(0,0,0),b=0,v=R,U=Ye}return}te=te||le,Te=Te||X,Ve=Ve||Y,(le!==p||te!==y)&&(i.blendEquationSeparate(P[le],P[te]),p=le,y=te),(X!==f||Y!==E||Te!==T||Ve!==N)&&(i.blendFuncSeparate(Ne[X],Ne[Y],Ne[Te],Ne[Ve]),f=X,E=Y,T=Te,N=Ve),(et.equals(w)===!1||st!==b)&&(i.blendColor(et.r,et.g,et.b,st),w.copy(et),b=st),v=R,U=!1}function Ge(R,le){R.side===2?ie(i.CULL_FACE):he(i.CULL_FACE);let X=R.side===1;le&&(X=!X),ue(X),R.blending===1&&R.transparent===!1?_e(0):_e(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),s.setFunc(R.depthFunc),s.setTest(R.depthTest),s.setMask(R.depthWrite),r.setMask(R.colorWrite);const Y=R.stencilWrite;a.setTest(Y),Y&&(a.setMask(R.stencilWriteMask),a.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),a.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),we(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?he(i.SAMPLE_ALPHA_TO_COVERAGE):ie(i.SAMPLE_ALPHA_TO_COVERAGE)}function ue(R){S!==R&&(R?i.frontFace(i.CW):i.frontFace(i.CCW),S=R)}function Be(R){R!==0?(he(i.CULL_FACE),R!==x&&(R===1?i.cullFace(i.BACK):R===2?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ie(i.CULL_FACE),x=R}function Ie(R){R!==C&&(q&&i.lineWidth(R),C=R)}function we(R,le,X){R?(he(i.POLYGON_OFFSET_FILL),(G!==le||O!==X)&&(i.polygonOffset(le,X),G=le,O=X)):ie(i.POLYGON_OFFSET_FILL)}function tt(R){R?he(i.SCISSOR_TEST):ie(i.SCISSOR_TEST)}function A(R){R===void 0&&(R=i.TEXTURE0+k-1),V!==R&&(i.activeTexture(R),V=R)}function g(R,le,X){X===void 0&&(V===null?X=i.TEXTURE0+k-1:X=V);let Y=oe[X];Y===void 0&&(Y={type:void 0,texture:void 0},oe[X]=Y),(Y.type!==R||Y.texture!==le)&&(V!==X&&(i.activeTexture(X),V=X),i.bindTexture(R,le||J[R]),Y.type=R,Y.texture=le)}function z(){const R=oe[V];R!==void 0&&R.type!==void 0&&(i.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function $(){try{i.compressedTexImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function xe(){try{i.texSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function re(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function se(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Le(){try{i.texStorage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Q(){try{i.texStorage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ge(){try{i.texImage2D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Oe(){try{i.texImage3D.apply(i,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ee(R){Fe.equals(R)===!1&&(i.scissor(R.x,R.y,R.z,R.w),Fe.copy(R))}function ae(R){ke.equals(R)===!1&&(i.viewport(R.x,R.y,R.z,R.w),ke.copy(R))}function De(R,le){let X=c.get(le);X===void 0&&(X=new WeakMap,c.set(le,X));let Y=X.get(R);Y===void 0&&(Y=i.getUniformBlockIndex(le,R.name),X.set(R,Y))}function He(R,le){const Y=c.get(le).get(R);o.get(le)!==Y&&(i.uniformBlockBinding(le,Y,R.__bindingPointIndex),o.set(le,Y))}function Qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},V=null,oe={},l={},u=new WeakMap,m=[],d=null,_=!1,v=null,p=null,f=null,E=null,y=null,T=null,N=null,w=new Ue(0,0,0),b=0,U=!1,S=null,x=null,C=null,G=null,O=null,Fe.set(0,0,i.canvas.width,i.canvas.height),ke.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:he,disable:ie,bindFramebuffer:Pe,drawBuffers:be,useProgram:ze,setBlending:_e,setMaterial:Ge,setFlipSided:ue,setCullFace:Be,setLineWidth:Ie,setPolygonOffset:we,setScissorTest:tt,activeTexture:A,bindTexture:g,unbindTexture:z,compressedTexImage2D:$,compressedTexImage3D:Z,texImage2D:ge,texImage3D:Oe,updateUBOMapping:De,uniformBlockBinding:He,texStorage2D:Le,texStorage3D:Q,texSubImage2D:j,texSubImage3D:xe,compressedTexSubImage2D:re,compressedTexSubImage3D:se,scissor:Ee,viewport:ae,reset:Qe}}function yu(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Ae,l=new WeakMap;let u;const m=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(A,g){return d?new OffscreenCanvas(A,g):Gi("canvas")}function v(A,g,z){let $=1;const Z=tt(A);if((Z.width>z||Z.height>z)&&($=z/Math.max(Z.width,Z.height)),$<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const j=Math.floor($*Z.width),xe=Math.floor($*Z.height);u===void 0&&(u=_(j,xe));const re=g?_(j,xe):u;return re.width=j,re.height=xe,re.getContext("2d").drawImage(A,0,0,j,xe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+j+"x"+xe+")."),re}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),A;return A}function p(A){return A.generateMipmaps&&A.minFilter!==1003&&A.minFilter!==1006}function f(A){i.generateMipmap(A)}function E(A,g,z,$,Z=!1){if(A!==null){if(i[A]!==void 0)return i[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let j=g;if(g===i.RED&&(z===i.FLOAT&&(j=i.R32F),z===i.HALF_FLOAT&&(j=i.R16F),z===i.UNSIGNED_BYTE&&(j=i.R8)),g===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.R8UI),z===i.UNSIGNED_SHORT&&(j=i.R16UI),z===i.UNSIGNED_INT&&(j=i.R32UI),z===i.BYTE&&(j=i.R8I),z===i.SHORT&&(j=i.R16I),z===i.INT&&(j=i.R32I)),g===i.RG&&(z===i.FLOAT&&(j=i.RG32F),z===i.HALF_FLOAT&&(j=i.RG16F),z===i.UNSIGNED_BYTE&&(j=i.RG8)),g===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(j=i.RG8UI),z===i.UNSIGNED_SHORT&&(j=i.RG16UI),z===i.UNSIGNED_INT&&(j=i.RG32UI),z===i.BYTE&&(j=i.RG8I),z===i.SHORT&&(j=i.RG16I),z===i.INT&&(j=i.RG32I)),g===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),g===i.RGBA){const xe=Z?Bi:qe.getTransfer($);z===i.FLOAT&&(j=i.RGBA32F),z===i.HALF_FLOAT&&(j=i.RGBA16F),z===i.UNSIGNED_BYTE&&(j=xe===$e?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function y(A,g){let z;return A?g===null||g===1014||g===1020?z=i.DEPTH24_STENCIL8:g===1015?z=i.DEPTH32F_STENCIL8:g===1012&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===1014||g===1020?z=i.DEPTH_COMPONENT24:g===1015?z=i.DEPTH_COMPONENT32F:g===1012&&(z=i.DEPTH_COMPONENT16),z}function T(A,g){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==1003&&A.minFilter!==1006?Math.log2(Math.max(g.width,g.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?g.mipmaps.length:1}function N(A){const g=A.target;g.removeEventListener("dispose",N),b(g),g.isVideoTexture&&l.delete(g)}function w(A){const g=A.target;g.removeEventListener("dispose",w),S(g)}function b(A){const g=n.get(A);if(g.__webglInit===void 0)return;const z=A.source,$=m.get(z);if($){const Z=$[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&U(A),Object.keys($).length===0&&m.delete(z)}n.remove(A)}function U(A){const g=n.get(A);i.deleteTexture(g.__webglTexture);const z=A.source,$=m.get(z);delete $[g.__cacheKey],a.memory.textures--}function S(A){const g=n.get(A);if(A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(g.__webglFramebuffer[$]))for(let Z=0;Z<g.__webglFramebuffer[$].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[$][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[$]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[$])}else{if(Array.isArray(g.__webglFramebuffer))for(let $=0;$<g.__webglFramebuffer.length;$++)i.deleteFramebuffer(g.__webglFramebuffer[$]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let $=0;$<g.__webglColorRenderbuffer.length;$++)g.__webglColorRenderbuffer[$]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[$]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const z=A.textures;for(let $=0,Z=z.length;$<Z;$++){const j=n.get(z[$]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(z[$])}n.remove(A)}let x=0;function C(){x=0}function G(){const A=x;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),x+=1,A}function O(A){const g=[];return g.push(A.wrapS),g.push(A.wrapT),g.push(A.wrapR||0),g.push(A.magFilter),g.push(A.minFilter),g.push(A.anisotropy),g.push(A.internalFormat),g.push(A.format),g.push(A.type),g.push(A.generateMipmaps),g.push(A.premultiplyAlpha),g.push(A.flipY),g.push(A.unpackAlignment),g.push(A.colorSpace),g.join()}function k(A,g){const z=n.get(A);if(A.isVideoTexture&&Ie(A),A.isRenderTargetTexture===!1&&A.version>0&&z.__version!==A.version){const $=A.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ke(z,A,g);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+g)}function q(A,g){const z=n.get(A);if(A.version>0&&z.__version!==A.version){ke(z,A,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+g)}function H(A,g){const z=n.get(A);if(A.version>0&&z.__version!==A.version){ke(z,A,g);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+g)}function K(A,g){const z=n.get(A);if(A.version>0&&z.__version!==A.version){W(z,A,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+g)}const V={1e3:i.REPEAT,1001:i.CLAMP_TO_EDGE,1002:i.MIRRORED_REPEAT},oe={1003:i.NEAREST,1004:i.NEAREST_MIPMAP_NEAREST,1005:i.NEAREST_MIPMAP_LINEAR,1006:i.LINEAR,1007:i.LINEAR_MIPMAP_NEAREST,1008:i.LINEAR_MIPMAP_LINEAR},fe={512:i.NEVER,519:i.ALWAYS,513:i.LESS,515:i.LEQUAL,514:i.EQUAL,518:i.GEQUAL,516:i.GREATER,517:i.NOTEQUAL};function pe(A,g){if(g.type===1015&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===1006||g.magFilter===1007||g.magFilter===1005||g.magFilter===1008||g.minFilter===1006||g.minFilter===1007||g.minFilter===1005||g.minFilter===1008)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,V[g.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,V[g.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,V[g.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,oe[g.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,oe[g.minFilter]),g.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,fe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===1003||g.minFilter!==1005&&g.minFilter!==1008||g.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Fe(A,g){let z=!1;A.__webglInit===void 0&&(A.__webglInit=!0,g.addEventListener("dispose",N));const $=g.source;let Z=m.get($);Z===void 0&&(Z={},m.set($,Z));const j=O(g);if(j!==A.__cacheKey){Z[j]===void 0&&(Z[j]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),Z[j].usedTimes++;const xe=Z[A.__cacheKey];xe!==void 0&&(Z[A.__cacheKey].usedTimes--,xe.usedTimes===0&&U(g)),A.__cacheKey=j,A.__webglTexture=Z[j].texture}return z}function ke(A,g,z){let $=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&($=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&($=i.TEXTURE_3D);const Z=Fe(A,g),j=g.source;t.bindTexture($,A.__webglTexture,i.TEXTURE0+z);const xe=n.get(j);if(j.version!==xe.__version||Z===!0){t.activeTexture(i.TEXTURE0+z);const re=qe.getPrimaries(qe.workingColorSpace),se=g.colorSpace===Jt?null:qe.getPrimaries(g.colorSpace),Le=g.colorSpace===Jt||re===se?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le);let Q=v(g.image,!1,r.maxTextureSize);Q=we(g,Q);const ge=s.convert(g.format,g.colorSpace),Oe=s.convert(g.type);let Ee=E(g.internalFormat,ge,Oe,g.colorSpace,g.isVideoTexture);pe($,g);let ae;const De=g.mipmaps,He=g.isVideoTexture!==!0,Qe=xe.__version===void 0||Z===!0,R=j.dataReady,le=T(g,Q);if(g.isDepthTexture)Ee=y(g.format===1027,g.type),Qe&&(He?t.texStorage2D(i.TEXTURE_2D,1,Ee,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,Ee,Q.width,Q.height,0,ge,Oe,null));else if(g.isDataTexture)if(De.length>0){He&&Qe&&t.texStorage2D(i.TEXTURE_2D,le,Ee,De[0].width,De[0].height);for(let X=0,Y=De.length;X<Y;X++)ae=De[X],He?R&&t.texSubImage2D(i.TEXTURE_2D,X,0,0,ae.width,ae.height,ge,Oe,ae.data):t.texImage2D(i.TEXTURE_2D,X,Ee,ae.width,ae.height,0,ge,Oe,ae.data);g.generateMipmaps=!1}else He?(Qe&&t.texStorage2D(i.TEXTURE_2D,le,Ee,Q.width,Q.height),R&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Q.width,Q.height,ge,Oe,Q.data)):t.texImage2D(i.TEXTURE_2D,0,Ee,Q.width,Q.height,0,ge,Oe,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){He&&Qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,le,Ee,De[0].width,De[0].height,Q.depth);for(let X=0,Y=De.length;X<Y;X++)if(ae=De[X],g.format!==1023)if(ge!==null)if(He){if(R)if(g.layerUpdates.size>0){for(const te of g.layerUpdates){const Te=ae.width*ae.height;t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,X,0,0,te,ae.width,ae.height,1,ge,ae.data.slice(Te*te,Te*(te+1)),0,0)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,X,0,0,0,ae.width,ae.height,Q.depth,ge,ae.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,X,Ee,ae.width,ae.height,Q.depth,0,ae.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?R&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,X,0,0,0,ae.width,ae.height,Q.depth,ge,Oe,ae.data):t.texImage3D(i.TEXTURE_2D_ARRAY,X,Ee,ae.width,ae.height,Q.depth,0,ge,Oe,ae.data)}else{He&&Qe&&t.texStorage2D(i.TEXTURE_2D,le,Ee,De[0].width,De[0].height);for(let X=0,Y=De.length;X<Y;X++)ae=De[X],g.format!==1023?ge!==null?He?R&&t.compressedTexSubImage2D(i.TEXTURE_2D,X,0,0,ae.width,ae.height,ge,ae.data):t.compressedTexImage2D(i.TEXTURE_2D,X,Ee,ae.width,ae.height,0,ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?R&&t.texSubImage2D(i.TEXTURE_2D,X,0,0,ae.width,ae.height,ge,Oe,ae.data):t.texImage2D(i.TEXTURE_2D,X,Ee,ae.width,ae.height,0,ge,Oe,ae.data)}else if(g.isDataArrayTexture)if(He){if(Qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,le,Ee,Q.width,Q.height,Q.depth),R)if(g.layerUpdates.size>0){let X;switch(Oe){case i.UNSIGNED_BYTE:switch(ge){case i.ALPHA:X=1;break;case i.LUMINANCE:X=1;break;case i.LUMINANCE_ALPHA:X=2;break;case i.RGB:X=3;break;case i.RGBA:X=4;break;default:throw new Error(`Unknown texel size for format ${ge}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:X=1;break;default:throw new Error(`Unknown texel size for type ${Oe}.`)}const Y=Q.width*Q.height*X;for(const te of g.layerUpdates)t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,te,Q.width,Q.height,1,ge,Oe,Q.data.slice(Y*te,Y*(te+1)));g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ge,Oe,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ee,Q.width,Q.height,Q.depth,0,ge,Oe,Q.data);else if(g.isData3DTexture)He?(Qe&&t.texStorage3D(i.TEXTURE_3D,le,Ee,Q.width,Q.height,Q.depth),R&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ge,Oe,Q.data)):t.texImage3D(i.TEXTURE_3D,0,Ee,Q.width,Q.height,Q.depth,0,ge,Oe,Q.data);else if(g.isFramebufferTexture){if(Qe)if(He)t.texStorage2D(i.TEXTURE_2D,le,Ee,Q.width,Q.height);else{let X=Q.width,Y=Q.height;for(let te=0;te<le;te++)t.texImage2D(i.TEXTURE_2D,te,Ee,X,Y,0,ge,Oe,null),X>>=1,Y>>=1}}else if(De.length>0){if(He&&Qe){const X=tt(De[0]);t.texStorage2D(i.TEXTURE_2D,le,Ee,X.width,X.height)}for(let X=0,Y=De.length;X<Y;X++)ae=De[X],He?R&&t.texSubImage2D(i.TEXTURE_2D,X,0,0,ge,Oe,ae):t.texImage2D(i.TEXTURE_2D,X,Ee,ge,Oe,ae);g.generateMipmaps=!1}else if(He){if(Qe){const X=tt(Q);t.texStorage2D(i.TEXTURE_2D,le,Ee,X.width,X.height)}R&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ge,Oe,Q)}else t.texImage2D(i.TEXTURE_2D,0,Ee,ge,Oe,Q);p(g)&&f($),xe.__version=j.version,g.onUpdate&&g.onUpdate(g)}A.__version=g.version}function W(A,g,z){if(g.image.length!==6)return;const $=Fe(A,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+z);const j=n.get(Z);if(Z.version!==j.__version||$===!0){t.activeTexture(i.TEXTURE0+z);const xe=qe.getPrimaries(qe.workingColorSpace),re=g.colorSpace===Jt?null:qe.getPrimaries(g.colorSpace),se=g.colorSpace===Jt||xe===re?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);const Le=g.isCompressedTexture||g.image[0].isCompressedTexture,Q=g.image[0]&&g.image[0].isDataTexture,ge=[];for(let Y=0;Y<6;Y++)!Le&&!Q?ge[Y]=v(g.image[Y],!0,r.maxCubemapSize):ge[Y]=Q?g.image[Y].image:g.image[Y],ge[Y]=we(g,ge[Y]);const Oe=ge[0],Ee=s.convert(g.format,g.colorSpace),ae=s.convert(g.type),De=E(g.internalFormat,Ee,ae,g.colorSpace),He=g.isVideoTexture!==!0,Qe=j.__version===void 0||$===!0,R=Z.dataReady;let le=T(g,Oe);pe(i.TEXTURE_CUBE_MAP,g);let X;if(Le){He&&Qe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,le,De,Oe.width,Oe.height);for(let Y=0;Y<6;Y++){X=ge[Y].mipmaps;for(let te=0;te<X.length;te++){const Te=X[te];g.format!==1023?Ee!==null?He?R&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te,0,0,Te.width,Te.height,Ee,Te.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te,De,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):He?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te,0,0,Te.width,Te.height,Ee,ae,Te.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te,De,Te.width,Te.height,0,Ee,ae,Te.data)}}}else{if(X=g.mipmaps,He&&Qe){X.length>0&&le++;const Y=tt(ge[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,le,De,Y.width,Y.height)}for(let Y=0;Y<6;Y++)if(Q){He?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,ge[Y].width,ge[Y].height,Ee,ae,ge[Y].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,De,ge[Y].width,ge[Y].height,0,Ee,ae,ge[Y].data);for(let te=0;te<X.length;te++){const Ve=X[te].image[Y].image;He?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te+1,0,0,Ve.width,Ve.height,Ee,ae,Ve.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te+1,De,Ve.width,Ve.height,0,Ee,ae,Ve.data)}}else{He?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,Ee,ae,ge[Y]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,De,Ee,ae,ge[Y]);for(let te=0;te<X.length;te++){const Te=X[te];He?R&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te+1,0,0,Ee,ae,Te.image[Y]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,te+1,De,Ee,ae,Te.image[Y])}}}p(g)&&f(i.TEXTURE_CUBE_MAP),j.__version=Z.version,g.onUpdate&&g.onUpdate(g)}A.__version=g.version}function J(A,g,z,$,Z,j){const xe=s.convert(z.format,z.colorSpace),re=s.convert(z.type),se=E(z.internalFormat,xe,re,z.colorSpace);if(!n.get(g).__hasExternalTextures){const Q=Math.max(1,g.width>>j),ge=Math.max(1,g.height>>j);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,j,se,Q,ge,g.depth,0,xe,re,null):t.texImage2D(Z,j,se,Q,ge,0,xe,re,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),Be(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,Z,n.get(z).__webglTexture,0,ue(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,$,Z,n.get(z).__webglTexture,j),t.bindFramebuffer(i.FRAMEBUFFER,null)}function he(A,g,z){if(i.bindRenderbuffer(i.RENDERBUFFER,A),g.depthBuffer){const $=g.depthTexture,Z=$&&$.isDepthTexture?$.type:null,j=y(g.stencilBuffer,Z),xe=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=ue(g);Be(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,re,j,g.width,g.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,re,j,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,j,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,xe,i.RENDERBUFFER,A)}else{const $=g.textures;for(let Z=0;Z<$.length;Z++){const j=$[Z],xe=s.convert(j.format,j.colorSpace),re=s.convert(j.type),se=E(j.internalFormat,xe,re,j.colorSpace),Le=ue(g);z&&Be(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Le,se,g.width,g.height):Be(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Le,se,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,se,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ie(A,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),k(g.depthTexture,0);const $=n.get(g.depthTexture).__webglTexture,Z=ue(g);if(g.depthTexture.format===1026)Be(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0);else if(g.depthTexture.format===1027)Be(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Pe(A){const g=n.get(A),z=A.isWebGLCubeRenderTarget===!0;if(A.depthTexture&&!g.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");ie(g.__webglFramebuffer,A)}else if(z){g.__webglDepthbuffer=[];for(let $=0;$<6;$++)t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[$]),g.__webglDepthbuffer[$]=i.createRenderbuffer(),he(g.__webglDepthbuffer[$],A,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=i.createRenderbuffer(),he(g.__webglDepthbuffer,A,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function be(A,g,z){const $=n.get(A);g!==void 0&&J($.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&Pe(A)}function ze(A){const g=A.texture,z=n.get(A),$=n.get(g);A.addEventListener("dispose",w);const Z=A.textures,j=A.isWebGLCubeRenderTarget===!0,xe=Z.length>1;if(xe||($.__webglTexture===void 0&&($.__webglTexture=i.createTexture()),$.__version=g.version,a.memory.textures++),j){z.__webglFramebuffer=[];for(let re=0;re<6;re++)if(g.mipmaps&&g.mipmaps.length>0){z.__webglFramebuffer[re]=[];for(let se=0;se<g.mipmaps.length;se++)z.__webglFramebuffer[re][se]=i.createFramebuffer()}else z.__webglFramebuffer[re]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){z.__webglFramebuffer=[];for(let re=0;re<g.mipmaps.length;re++)z.__webglFramebuffer[re]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(xe)for(let re=0,se=Z.length;re<se;re++){const Le=n.get(Z[re]);Le.__webglTexture===void 0&&(Le.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&Be(A)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let re=0;re<Z.length;re++){const se=Z[re];z.__webglColorRenderbuffer[re]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[re]);const Le=s.convert(se.format,se.colorSpace),Q=s.convert(se.type),ge=E(se.internalFormat,Le,Q,se.colorSpace,A.isXRRenderTarget===!0),Oe=ue(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Oe,ge,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,z.__webglColorRenderbuffer[re])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),he(z.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),pe(i.TEXTURE_CUBE_MAP,g);for(let re=0;re<6;re++)if(g.mipmaps&&g.mipmaps.length>0)for(let se=0;se<g.mipmaps.length;se++)J(z.__webglFramebuffer[re][se],A,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,se);else J(z.__webglFramebuffer[re],A,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);p(g)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(xe){for(let re=0,se=Z.length;re<se;re++){const Le=Z[re],Q=n.get(Le);t.bindTexture(i.TEXTURE_2D,Q.__webglTexture),pe(i.TEXTURE_2D,Le),J(z.__webglFramebuffer,A,Le,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,0),p(Le)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let re=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(re=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,$.__webglTexture),pe(re,g),g.mipmaps&&g.mipmaps.length>0)for(let se=0;se<g.mipmaps.length;se++)J(z.__webglFramebuffer[se],A,g,i.COLOR_ATTACHMENT0,re,se);else J(z.__webglFramebuffer,A,g,i.COLOR_ATTACHMENT0,re,0);p(g)&&f(re),t.unbindTexture()}A.depthBuffer&&Pe(A)}function P(A){const g=A.textures;for(let z=0,$=g.length;z<$;z++){const Z=g[z];if(p(Z)){const j=A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,xe=n.get(Z).__webglTexture;t.bindTexture(j,xe),f(j),t.unbindTexture()}}}const Ne=[],_e=[];function Ge(A){if(A.samples>0){if(Be(A)===!1){const g=A.textures,z=A.width,$=A.height;let Z=i.COLOR_BUFFER_BIT;const j=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,xe=n.get(A),re=g.length>1;if(re)for(let se=0;se<g.length;se++)t.bindFramebuffer(i.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,xe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,xe.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,xe.__webglFramebuffer);for(let se=0;se<g.length;se++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),re){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,xe.__webglColorRenderbuffer[se]);const Le=n.get(g[se]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Le,0)}i.blitFramebuffer(0,0,z,$,0,0,z,$,Z,i.NEAREST),c===!0&&(Ne.length=0,_e.length=0,Ne.push(i.COLOR_ATTACHMENT0+se),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Ne.push(j),_e.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,_e)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ne))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),re)for(let se=0;se<g.length;se++){t.bindFramebuffer(i.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.RENDERBUFFER,xe.__webglColorRenderbuffer[se]);const Le=n.get(g[se]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,xe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+se,i.TEXTURE_2D,Le,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,xe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const g=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function ue(A){return Math.min(r.maxSamples,A.samples)}function Be(A){const g=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ie(A){const g=a.render.frame;l.get(A)!==g&&(l.set(A,g),A.update())}function we(A,g){const z=A.colorSpace,$=A.format,Z=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||z!==Qt&&z!==Jt&&(qe.getTransfer(z)===$e?($!==1023||Z!==1009)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),g}function tt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(h.width=A.naturalWidth||A.width,h.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(h.width=A.displayWidth,h.height=A.displayHeight):(h.width=A.width,h.height=A.height),h}this.allocateTextureUnit=G,this.resetTextureUnits=C,this.setTexture2D=k,this.setTexture2DArray=q,this.setTexture3D=H,this.setTextureCube=K,this.rebindTextures=be,this.setupRenderTarget=ze,this.updateRenderTargetMipmap=P,this.updateMultisampleRenderTarget=Ge,this.setupDepthRenderbuffer=Pe,this.setupFrameBufferTexture=J,this.useMultisampledRTT=Be}function Eu(i,e){function t(n,r=Jt){let s;const a=qe.getTransfer(r);if(n===1009)return i.UNSIGNED_BYTE;if(n===1017)return i.UNSIGNED_SHORT_4_4_4_4;if(n===1018)return i.UNSIGNED_SHORT_5_5_5_1;if(n===35902)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===1010)return i.BYTE;if(n===1011)return i.SHORT;if(n===1012)return i.UNSIGNED_SHORT;if(n===1013)return i.INT;if(n===1014)return i.UNSIGNED_INT;if(n===1015)return i.FLOAT;if(n===1016)return i.HALF_FLOAT;if(n===1021)return i.ALPHA;if(n===1022)return i.RGB;if(n===1023)return i.RGBA;if(n===1024)return i.LUMINANCE;if(n===1025)return i.LUMINANCE_ALPHA;if(n===1026)return i.DEPTH_COMPONENT;if(n===1027)return i.DEPTH_STENCIL;if(n===1028)return i.RED;if(n===1029)return i.RED_INTEGER;if(n===1030)return i.RG;if(n===1031)return i.RG_INTEGER;if(n===1033)return i.RGBA_INTEGER;if(n===33776||n===33777||n===33778||n===33779)if(a===$e)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===35840||n===35841||n===35842||n===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===36196||n===37492||n===37496)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===36196||n===37492)return a===$e?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===37496)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===37808||n===37809||n===37810||n===37811||n===37812||n===37813||n===37814||n===37815||n===37816||n===37817||n===37818||n===37819||n===37820||n===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===37808)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===37809)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===37810)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===37811)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===37812)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===37813)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===37814)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===37815)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===37816)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===37817)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===37818)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===37819)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===37820)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===37821)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===36492||n===36494||n===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===36492)return a===$e?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===36283||n===36284||n===36285||n===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===36492)return s.COMPRESSED_RED_RGTC1_EXT;if(n===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===1020?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Tu extends bt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ci extends _t{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Au={type:"move"};class yr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ci,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ci,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new I,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new I),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ci,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new I,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new I),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,a=null;const o=this._targetRay,c=this._grip,h=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(h&&e.hand){a=!0;for(const v of e.hand.values()){const p=t.getJointPose(v,n),f=this._getHandJoint(h,v);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}const l=h.joints["index-finger-tip"],u=h.joints["thumb-tip"],m=l.position.distanceTo(u.position),d=.02,_=.005;h.inputState.pinching&&m>d+_?(h.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!h.inputState.pinching&&m<=d-_&&(h.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Au)))}return o!==null&&(o.visible=r!==null),c!==null&&(c.visible=s!==null),h!==null&&(h.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Ci;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const bu=`
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Bn.BlurDirectionX=new Ae(1,0);Bn.BlurDirectionY=new Ae(0,1);function $u(i){const e=new Uu({canvas:i,antialias:!0,powerPreference:"high-performance"});e.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.setSize(window.innerWidth,window.innerHeight),e.toneMapping=4,e.toneMappingExposure=1;const t=new Iu;t.background=new Ue(0);const n=new bt(75,window.innerWidth/window.innerHeight,.1,200);n.position.set(0,0,6);const r=new qu(e);r.addPass(new Yu(t,n));const s=new Bn(new Ae(window.innerWidth,window.innerHeight),1.5,.5,0);r.addPass(s);function a(){const o=window.innerWidth,c=window.innerHeight;n.aspect=o/c,n.updateProjectionMatrix(),e.setSize(o,c),r.setSize(o,c)}return window.addEventListener("resize",a),{renderer:e,scene:t,camera:n,composer:r,bloom:s}}class Zu{constructor(){this.settings={sensitivity:1.5,bloomStrength:1.5,speed:1,intensity:1,palette:0,autoColor:!1},this.visible=!0,this._onSourceChange=null,this._onModeChange=null}init({onSourceChange:e,onModeChange:t,onModeNameChange:n}){this._onSourceChange=e,this._onModeChange=t,this._panel=document.getElementById("panel"),this._modeLabel=document.getElementById("mode-name"),document.getElementById("prev-mode").addEventListener("click",()=>{n(t("prev"))}),document.getElementById("next-mode").addEventListener("click",()=>{n(t("next"))});const r=document.getElementById("src-mic"),s=document.getElementById("src-system");r.addEventListener("click",()=>{r.classList.add("active"),s.classList.remove("active"),e("mic")}),s.addEventListener("click",()=>{s.classList.add("active"),r.classList.remove("active"),e("system")}),document.querySelectorAll(".palette-btn").forEach(h=>{h.addEventListener("click",()=>{document.querySelectorAll(".palette-btn").forEach(l=>l.classList.remove("active")),h.classList.add("active"),this.settings.palette=parseInt(h.dataset.palette,10)})});const a=document.getElementById("auto-color-btn");a&&a.addEventListener("click",()=>{this.settings.autoColor=!this.settings.autoColor,a.classList.toggle("active",this.settings.autoColor),document.querySelectorAll(".palette-btn").forEach(h=>{h.style.opacity=this.settings.autoColor?"0.4":"",h.style.pointerEvents=this.settings.autoColor?"none":""})}),this._bindSlider("sl-sensitivity","val-sensitivity","sensitivity",h=>h.toFixed(1)+"×"),this._bindSlider("sl-bloom","val-bloom","bloomStrength",h=>h.toFixed(1)),this._bindSlider("sl-speed","val-speed","speed",h=>h.toFixed(1)+"×"),this._bindSlider("sl-intensity","val-intensity","intensity",h=>h.toFixed(1)+"×");const o=document.getElementById("sl-sensitivity"),c=document.getElementById("val-sensitivity");document.querySelectorAll(".boost-btn").forEach(h=>{h.addEventListener("click",()=>{const l=parseFloat(h.dataset.sens);this.settings.sensitivity=l,o.value=l,c.textContent=l.toFixed(1)+"×",document.querySelectorAll(".boost-btn").forEach(u=>u.classList.toggle("active",u===h))})}),o.addEventListener("input",()=>{document.querySelectorAll(".boost-btn").forEach(h=>h.classList.remove("active"))}),document.getElementById("toggle-panel").addEventListener("click",()=>this.toggle()),document.addEventListener("keydown",h=>{h.target.tagName!=="INPUT"&&((h.key==="h"||h.key==="H")&&this.toggle(),(h.key==="m"||h.key==="M")&&n(t("next")))})}_bindSlider(e,t,n,r){const s=document.getElementById(e),a=document.getElementById(t);s.addEventListener("input",()=>{const o=parseFloat(s.value);this.settings[n]=o,a.textContent=r(o)})}setModeName(e){this._modeLabel&&(this._modeLabel.textContent=e)}toggle(){this.visible=!this.visible,this._panel.classList.toggle("hidden",!this.visible)}}new Ue;function zr(i,e,t,n,r){switch(r){case 1:i.setHSL(e*.12%1,t,n);break;case 2:i.setHSL((.55+e*.22)%1,t*.9,n*.85);break;case 3:i.setHSL(0,0,n);break;default:i.setHSL(e%1,t,n)}}function fa(){return`
